...
LCDTask(void* pData)
{
    ...
    else
    {
        ...
        alt_up_character_lcd_string(pLCD, "Ready");
    }
    ...
    // This section of code will only be executed in the case of a malloc error
    if (pExportedRecording != NULL)
    {
        free(pExportedRecording);
        pExportedRecording = NULL;
    }
